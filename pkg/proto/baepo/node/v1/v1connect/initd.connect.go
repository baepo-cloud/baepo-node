...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/baepo-cloud/baepo-node/pkg/proto/baepo/node/v1"
...
const (
	...
	InitDHealthcheckProcedure = "/baepo.node.v1.InitD/Healthcheck"
)

// InitDClient is a client for the baepo.node.v1.InitD service.
type InitDClient interface {
	Healthcheck(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[emptypb.Empty], error)
}

// NewInitDClient constructs a client for the baepo.node.v1.InitD service. By default, it uses the
...
func NewInitDClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) InitDClient {
	...
	initDMethods := v1.File_proto_baepo_node_v1_initd_proto.Services().ByName("InitD").Methods()
	return &initDClient{
...
// Healthcheck calls baepo.node.v1.InitD.Healthcheck.
...
// InitDHandler is an implementation of the baepo.node.v1.InitD service.
...
func NewInitDHandler(svc InitDHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/baepo.node.v1.InitD/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedInitDHandler) Healthcheck(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("baepo.node.v1.InitD.Healthcheck is not implemented"))
}
