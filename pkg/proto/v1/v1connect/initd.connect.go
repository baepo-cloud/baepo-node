...
const (
	...
	InitDHealthcheckProcedure = "/v1.InitD/Healthcheck"
)

// InitDClient is a client for the v1.InitD service.
type InitDClient interface {
	Healthcheck(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[emptypb.Empty], error)
}

// NewInitDClient constructs a client for the v1.InitD service. By default, it uses the Connect
...
func NewInitDClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) InitDClient {
	...
	initDMethods := v1.File_proto_v1_initd_proto.Services().ByName("InitD").Methods()
	return &initDClient{
...
// Healthcheck calls v1.InitD.Healthcheck.
...
// InitDHandler is an implementation of the v1.InitD service.
...
func NewInitDHandler(svc InitDHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/v1.InitD/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedInitDHandler) Healthcheck(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.InitD.Healthcheck is not implemented"))
}
