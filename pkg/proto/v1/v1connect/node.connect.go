...
const (
	...
	NodeServiceName = "v1.NodeService"
)
...
const (
	...
	// RPC.
	NodeServiceStartMachineProcedure = "/v1.NodeService/StartMachine"
	// NodeServiceStopMachineProcedure is the fully-qualified name of the NodeService's StopMachine RPC.
	NodeServiceStopMachineProcedure = "/v1.NodeService/StopMachine"
	// NodeServiceHealthcheckMachineProcedure is the fully-qualified name of the NodeService's
	// HealthcheckMachine RPC.
	NodeServiceHealthcheckMachineProcedure = "/v1.NodeService/HealthcheckMachine"
)

// NodeServiceClient is a client for the v1.NodeService service.
...
// NewNodeServiceClient constructs a client for the v1.NodeService service. By default, it uses the
...
func NewNodeServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NodeServiceClient {
	...
	nodeServiceMethods := v1.File_proto_v1_node_proto.Services().ByName("NodeService").Methods()
...
// StartMachine calls v1.NodeService.StartMachine.
...
// StopMachine calls v1.NodeService.StopMachine.
...
// HealthcheckMachine calls v1.NodeService.HealthcheckMachine.
...
// NodeServiceHandler is an implementation of the v1.NodeService service.
...
func NewNodeServiceHandler(svc NodeServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/v1.NodeService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNodeServiceHandler) StartMachine(context.Context, *connect.Request[v1.NodeStartMachineRequest]) (*connect.Response[v1.NodeStartMachineReply], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.NodeService.StartMachine is not implemented"))
}
...
func (UnimplementedNodeServiceHandler) StopMachine(context.Context, *connect.Request[v1.NodeStopMachineRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.NodeService.StopMachine is not implemented"))
}
...
func (UnimplementedNodeServiceHandler) HealthcheckMachine(context.Context, *connect.Request[v1.NodeHealthcheckMachineRequest]) (*connect.Response[v1.NodeHealthcheckMachineReply], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.NodeService.HealthcheckMachine is not implemented"))
}
